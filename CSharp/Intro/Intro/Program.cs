...
Console.WriteLine("Hello, World!"); // Prints to console/terminal much like python: print("Hello, World!)
...
Console.WriteLine("a: " + a + ", greeting: " + greeting); // String Concatenation: recommended if performance is critical
