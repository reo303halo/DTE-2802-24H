...
public class ProductControllerTest
{
    ...
    public void EditReturnsViewResultWithProductEditViewModel()
    {
        ...
        var productEditViewModel = new ProductEditViewModel();
        _repository.Setup(repo => repo.GetProductEditViewModel(productEditViewModel.ProductId)).Returns(productEditViewModel);

        // Act
        var result = _controller.Edit(productEditViewModel.ProductId) as ViewResult;
    ...
    public void EditPostReturnsRedirectToActionResultWithValidModel()
    {
        ...
        _repository = new Mock<IProductRepository>();
        _controller = new ProductController(_repository.Object);
        var productEditViewModel = new ProductEditViewModel { ProductId = 1, Name = "Test Product", Description = "", Price = 14.50m, ManufacturerId = 1, CategoryId = 2 };
    ...
    public void DeleteRedirectToActionResultSuccessfully()
    {
        //Arrange
        _repository = new Mock<IProductRepository>();
        var product = new ProductEditViewModel { ProductId = 1, Name = "TestHammer", Price = 121.50m, Description = "Verktøy", ManufacturerId = 1, CategoryId = 1};
        _controller = new ProductController(_repository.Object);
